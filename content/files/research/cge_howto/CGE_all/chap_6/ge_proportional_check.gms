...
$ontext
Time-stamp:     <2021-02-19 17:05:44 st>
...
execute_unload "ge_proportional_check.gdx", results, results_pc;

*       $onecho ~ $offechoの間の部分をtemp.txtというファイルの中に出力
$onecho > temp.txt
i=ge_proportional_check.gdx o=ge_proportional_check.xlsx epsout=0
